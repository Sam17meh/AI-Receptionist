...
A voice AI receptionist that handles a salon's appointment booking end-to-end over a phone call — no human needed for routine scheduling. Built as a four-flow n8n backend wired to a [Retell AI](https://www.retellai.com/) conversational voice agent.
